    ...
    value: function turn() {
      ...
      for (var i = 0; i < this.activeEls.length; i++) {
        ...
        for (var y = element.gridPos.y; y < 0; y--) {
          var elAbove = this.getElement(new _Vector2["default"](element.gridPos.x, y - 1));
          console.log(elAbove);
        }
      }
