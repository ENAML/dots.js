...
},{"GameElements/Dot":96,"Grid":98,"Vector":101,"layoutManager":103}],96:[function(require,module,exports){
"use strict";
...
},{"../Vector":101,"../utils/mathUtils":104}],97:[function(require,module,exports){
"use strict";
...
},{"Board":95,"Renderer":99,"layoutManager":103,"utils/mathUtils":104}],98:[function(require,module,exports){
"use strict";
...
},{"Vector":101}],99:[function(require,module,exports){
"use strict";
...
var _RendererElementsDot = require("RendererElements/Dot");

var _RendererElementsDot2 = _interopRequireDefault(_RendererElementsDot);

var _utilsTweens = require("utils/tweens");

var tweens = _interopRequireWildcard(_utilsTweens);
  ...
  _createClass(Renderer, [{
      ...
      if (board) // should only run when game starts
        {
          for (var i = 0; i < board.grid.elements.length; i++) {
            ...
            var dot = new _RendererElementsDot2["default"]({
        ...
        } else // this should run whenever a turn is over and animations are done
        {
          ...
          for (var i = this.shiftingEls.children.length - 1; i >= 0; i--) {
            var element = this.shiftingEls.removeChildAt(i);
            this.staticStateEls.addChild(element);
          }
          for (var i = this.nonShiftingEls.children.length - 1; i >= 0; i--) {
            var element = this.nonShiftingEls.removeChildAt(i);
            this.staticStateEls.addChild(element);
          }
          for (var i = this.newEls.children.length - 1; i >= 0; i--) {
            var element = this.newEls.removeChildAt(i);
            this.staticStateEls.addChild(element);
          }

          // MUST GET RID OF ACTIVE ELEMENTS
          for (var i = this.activeEls.children.length - 1; i >= 0; i--) {
            var element = this.activeEls.children[i];
    ...
    value: function shrinkActive() {
      ...
      return function () {
        ...
        for (var i = 0; i < this.activeEls.children.length; i++) {
          var element = this.activeEls.children[i];
    ...
    value: function shiftDown() {
      ...
      for (var i = 0; i < this.shiftingEls.children.length; i++) {
        var element = this.shiftingEls.children[i];
    ...
    value: function populateNew() {
      var totalNewEls = this.newEls.children.length;
      for (var i = 0; i < totalNewEls; i++) {
        this.newEls.children[i].spawnFrameDelay = Math.floor(Math.random() * totalNewEls);
      }
      ...
      return function () {
        ...
        for (var i = 0; i < this.newEls.children.length; i++) {
          var element = this.newEls.children[i];
...
},{"RendererElements/Dot":100,"layoutManager":103,"utils/tweens":105}],100:[function(require,module,exports){
"use strict";
...
var Dot = (function (_PIXI$Container) {
  ...
  _createClass(Dot, [{
    ...
    value: function createChildren() {
      var loop = new Circle(0, 0, this.loopedRadius, this.dotType.color, this.loopedAlpha);

      var main = new Circle(0, 0, this.radius, this.dotType.color, 1);
    ...
    value: function update(usePreviousPosition) {
      ...
      if (this.children[0].radius !== this.loopedRadius || this.children[0].alpha !== this.loopedAlpha) {
...
var Circle = (function (_PIXI$Graphics) {
  ...
  _createClass(Circle, [{
    key: "redraw",
    value: function redraw(radius, alpha) {
      this.radius = radius;
      this.alpha = alpha;
...
},{"GameView":97,"babelify/polyfill":93}],103:[function(require,module,exports){
