...
var GameView = (function () {
  ...
  _createClass(GameView, [{
    ...
    value: function mouseMove(e) {
      if (!this.mousePressed || this.board.loopCompleted || !this.board.activeEls.length) return;
