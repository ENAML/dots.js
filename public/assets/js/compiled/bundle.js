...
var Dot = (function (_PIXI$Container) {
  ...
  _createClass(Dot, [{
    ...
    value: function createChildren() {
      var loop = new Circle(this.x, this.y, this.loopedRadius, this.dotType.color, this.loopedAlpha);

      var main = new Circle(this.x, this.y, this.radius, this.dotType.color, 1);
