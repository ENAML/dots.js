    ...
    value: function cloneGrid() {
      ...
      for (var i = 0; i < this.height; i++) {
        for (var j = 0; j < this.width; j++) {
          ...
          newDot.dotType = this.getElement(new _Vector2["default"](j, i)).dotType;
          cloned.push(newDot);
        }
      }
...
var GameView = (function () {
  ...
  _createClass(GameView, [{
    ...
    value: function mouseMove(e) {
      if (!this.mousePressed || !this.board.activeEls.length || this.board.isChanging) return;
...
var Renderer = (function () {
  ...
  _createClass(Renderer, [{
    ...
    key: "drawElement",
    value: function drawElement(board, element, i) {
